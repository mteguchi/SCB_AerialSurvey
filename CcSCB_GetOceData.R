...
dat2011 <- read.csv('Data/processed/SEGDATA_SCB2011_DAS_2km_2016-04-12.csv')
dat2015 <- read.csv('Data/processed/SEGDATA_SCB2015_DAS_2km_2016-04-12.csv')
...
for (i in 1:n.dates) {
  ...
  save(allchl, file = paste0('RData/chl', dates[i], '.RData'))
  ...
  save(allsst, file = paste0('RData/sst', dates[i], '.RData'))
