...
infile <- 'data/das files/SCB2018_DAS.822'
outfile <- 'data/tmpTracks_2018_0822.txt'
...
out.df <- data.frame(Date1 = Date1, Time1 = Time1, Lat1 = Lat1, Lon1 = Lon1,
