fcn.AirSegChopCc <- function(filename){
...
#filename <- paste0('Data/', fnames2015[1])

#filename <- 'test_EAB.das'
# filename <- 'CCS91_92_eab.das'

# creates part of output file name - remove directory names
#DASfile <- paste("_", getLast(unlist(strsplit(filename, '/'))) , "_", sep="")
DASfile <- paste("_", remove.ext(filename) , "_", sep="")
